                ...
                {!imagePreview ? (
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-xl sm:rounded-2xl lg:rounded-4xl p-3 sm:p-4 md:p-6 lg:p-8 text-center w-full max-w-5xl mx-auto aspect-[16/9] flex items-center justify-center relative bg-gray-50">
                    ...
                    <div className="relative w-full h-full flex items-center justify-center">
                      ...
                      {/* Trash Button */}
                      <button onClick={handleRemoveImage} className="absolute top-2 right-2 sm:top-4 sm:right-4 p-1.5 sm:p-2 bg-red-500 hover:bg-red-600 text-white rounded-full transition-all duration-200 hover:scale-110 hover:shadow-lg">
